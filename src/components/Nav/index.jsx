		...
		<nav className={Styles.nav}>
			<a className={Styles.logolink} href="/">
				<div className={Styles.monogram}>
					<img src="https://c.tenor.com/ZtY6xBiN2FgAAAAM/coroca-my-name-is-jeff.gif"/>
				</div>
			</a>
			...
			<a className={Styles.social} href="https://twitter.com/1rb0g1e">
